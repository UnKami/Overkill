...
**[Download the Windows installer — 0.22.0 playtest](https://github.com/UnKami/Overkill/releases/download/v0.22.0-test/OverkillSetup-0.22.0.exe)**
...
The current playtest is built from the `v0.22.0-test` tag on `feat/yonatan-sentinel-production`. Its gameplay changes are not yet merged into main. Open Releases, select 0.22.0, and expand Assets to find the installer.
