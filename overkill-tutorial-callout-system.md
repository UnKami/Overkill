...
1. **Teach by play, not by reading**: The core loop and arithmetic click through action and immediate visual feedback (the gray/amber split damage number, intent badges), not explanatory essays.
...
There are only **4 deliberate callout moments** across the entire onboarding journey:
