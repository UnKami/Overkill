...
| :--- | :--- | :--- | :--- | :--- |
| Yonatan / Codex | `feat/yonatan-sentinel-production` | Roster enemy intent readability | `scripts/combat/combat_controller.gd`, `scripts/combat/decision_preview.gd`, `scripts/combat/sentinel_production_test.gd`, `scripts/combat/enemy_intent_readout_test.gd`, `scripts/combat/enemy_intent_readout_test.gd.uid`, `scenes/enemy_intent_readout_test.tscn`, `docs/sentinel-production.md`, `CHANGELOG_AI.md` | 2026-09-19 |
