...
| :--- | :--- | :--- | :--- | :--- |
| Yonatan / Codex | `feat/yonatan-sentinel-production` | Authored Sentinel collapse | `scripts/art/build_sentinel.py`, `art_source/characters/sentinel-production.blend`, `assets/characters/rigged/sentinel.glb`, `scripts/combat/finish_sequence_test.gd`, `docs/sentinel-production.md`, `CHANGELOG_AI.md` | 2026-09-19 |
