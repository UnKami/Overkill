...
| :--- | :--- | :--- | :--- | :--- |
| Yonatan / Codex | `feat/yonatan-sentinel-production` | Sentinel enclosed helmet and neck armor | `scripts/art/build_sentinel.py`, `art_source/characters/sentinel-production.blend`, `assets/characters/rigged/sentinel.glb`, `scripts/combat/sentinel_production_test.gd`, `docs/sentinel-production.md`, `CHANGELOG_AI.md` | 2026-09-19 |
