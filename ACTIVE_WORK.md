...
| :--- | :--- | :--- | :--- | :--- |
| Yonatan / Codex | `feat/yonatan-sentinel-production` | Battle camera composition and overlay clearance | `scripts/combat/directed_arena.gd`, `scripts/combat/sentinel_production_test.gd`, `docs/sentinel-production.md`, `CHANGELOG_AI.md` | 2026-09-19 |
