...
| :--- | :--- | :--- | :--- | :--- |
| Yonatan / Codex | `feat/yonatan-sentinel-production` | Cathedral architecture and floor hierarchy | `scripts/combat/directed_arena.gd`, `scripts/combat/cathedral_architecture.gd`, `scripts/combat/cathedral_architecture.gd.uid`, `scripts/combat/sentinel_production_test.gd`, `docs/sentinel-production.md`, `CHANGELOG_AI.md` | 2026-09-19 |
