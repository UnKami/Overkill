...
| :--- | :--- | :--- | :--- | :--- |
| Yonatan / Codex | `feat/yonatan-sentinel-production` | Forged weapon material and blade planes | `assets/shaders/forged_metal.gdshader`, `scripts/combat/forged_armor.gd`, `scripts/combat/rigged_combatant.gd`, `docs/sentinel-production.md`, `CHANGELOG_AI.md` | 2026-09-19 |
