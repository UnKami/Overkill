...
| :--- | :--- | :--- | :--- | :--- |
| Yonatan / Codex | `feat/yonatan-sentinel-production` | Gravity-aware cloak drape | `assets/shaders/battle_cloth.gdshader`, `scripts/combat/rigged_combatant.gd`, `docs/sentinel-production.md`, `CHANGELOG_AI.md` | 2026-09-19 |
