...
| :--- | :--- | :--- | :--- | :--- |
| Yonatan / Codex | `feat/yonatan-sentinel-production` | Heavy attack cadence and recovery | `scripts/combat/rigged_combatant.gd`, `scripts/combat/directed_arena.gd`, `scripts/combat/combat_controller.gd`, `scripts/combat/encounter_quality_test.gd`, `scripts/combat/sentinel_production_test.gd`, `docs/sentinel-production.md`, `CHANGELOG_AI.md` | 2026-09-19 |
